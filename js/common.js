...
(function () {
    ...
    ['cardsP13',
        ...
        function Players(positionCards,firstCards,secondCards) {
            self = this;
        ...
        Players.prototype.calls = function (firstPlayer) {
            callsIteration(firstPlayer);
        };

        // Created Players
        var firstPlayer = new Players($('.firstPlayersPosition'),randomCards()[0][1],randomCards()[0][1]);
        ...
        // Calls
        function callsIteration(player) {
            console.log(player.find('.pointsPlayers').children('span').text());
